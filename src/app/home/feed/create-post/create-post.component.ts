...
export class CreatePostComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.authService.isLogged() ){
      ...
      this.createdPost.patchValue({ postedby: this.curUser.name });
      this.createdPost.get('postedby').updateValueAndValidity();
      this.createdPost.patchValue({ designation: this.curUser.designation });
      this.createdPost.get('designation').updateValueAndValidity();
